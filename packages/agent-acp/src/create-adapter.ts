...
import { pickSafeEnv } from "./engine/safe-env";
import type { AcpAgentProfile } from "./agents/types";
import { AcpAgentAdapter, type AcpPendingAction } from "./adapter";
...
export function createAcpAdapter(
  ...
  const baseEnv = cleanEnv(pickSafeEnv());
