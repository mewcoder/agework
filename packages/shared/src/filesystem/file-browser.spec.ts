...
import { browse, listFiles, readFile } from "./file-browser";
...
describe("file-browser path safety", () => {
...
describe("file-browser listFiles", () => {
  beforeEach(async () => {
...
describe("file-browser symlink handling", () => {
...
describe("file-browser readFile", () => {
...
describe("file-browser browse wrapper", () => {
