/**
 * Agent CLI 已知安装位置搜索：参考 claudian 的 findClaudeCLIPath 模式，
 * 覆盖 Windows / macOS / Linux 上常见的安装路径（AppData, Program Files, npm,
 * nvm, volta, chocolatey, scoop, homebrew, asdf 等）。
 */
