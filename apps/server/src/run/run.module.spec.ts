...
import { BUILTIN_RUNTIME_HOST } from "../host-dispatch/contract/builtin-runtime-host";
...
import { RuntimeHostAdapter } from "../host-dispatch/contract/runtime-host.adapter";
